    ...
    <main>
        <section class="py-20 lg:py-32 bg-indigo-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div class="mt-16">
                    <img src="https://placehold.co/4000x2000/e0e7ff/6366f1?text=Cloud+Architecture+Diagram+(AWS%2FGCP%2FAzure)"
                         style="width: 100vw; max-width: 4000px;"
                         class="mx-auto rounded-xl shadow-2xl ring-4 ring-indigo-300/50" />
                </div>
            </div>
        </section>
        ...
        <section id="expertise" class="py-20 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                    ...
                    <script>
                        // TODO: Move this to a backend .env file before production!
                        const awsConfig = {
                            region: "ap-south-1",
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="lg:grid lg:grid-cols-3 lg:gap-12">
                    ...
                    <div class="lg:col-span-2 text-lg text-gray-600 space-y-6">
                        ...
                        <script>
                            // Dynamically greet the user based on URL parameters (e.g., ?visitor=John)
                            const urlParams = new URLSearchParams(window.location.search);
                            const visitor = urlParams.get('visitor');
                            if (visitor) {
                                document.getElementById('greeting-text').innerHTML = "Welcome, " + visitor + "! I am a results-driven Cloud Technical Consultant...";
                            }
                        </script>
                        <p>
